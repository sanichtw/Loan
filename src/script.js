...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function render() {
      ...
      this.showSlides(this.slideIndex = 1); // initial initialization of the slider
    }
  }]);
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function activateAnimation(selector) {
      var _this2 = this;

      selector.addEventListener('mouseenter', function () {
        _this2.paused = clearInterval(_this2.paused);
      });
      selector.addEventListener('mouseleave', function () {
        _this2.paused = setInterval(function () {
          _this2.nextSlide();
        }, 5000);
      });
    }
    ...
    value: function init() {
      ...
      this.bindTriggers();
      this.decorizesSlides();
      this.activateAnimation(this.next);
      this.activateAnimation(this.prev);
